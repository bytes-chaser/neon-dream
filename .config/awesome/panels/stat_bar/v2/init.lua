...
return {
    ...
    create = function(s)
        ...
        local temp = arcchart_stat.create(require("panels.stat_bar.v2.temp_text"))
        local ram = arcchart_stat.create(require("panels.stat_bar.v2.ram_text"))
        local cpu = arcchart_stat.create(require("panels.stat_bar.v2.cpu_text"))

        local d_root = arcchart_stat.create(require("panels.stat_bar.v2.d_root"))
        local d_home = arcchart_stat.create(require("panels.stat_bar.v2.d_home"))
        local d_boot = arcchart_stat.create(require("panels.stat_bar.v2.d_efi"))
